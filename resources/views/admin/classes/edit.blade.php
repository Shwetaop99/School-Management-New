...
<div class="class-form-page">
    ...
    <div class="class-page-header">
        <h2>Edit Class</h2>
        <p>Update the details of this school class.</p>
    </div>
        ...
        <div class="class-form-card-body">
            ...
            <form action="{{ route('admin.classes.update', $schoolClass->id) }}" method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            name="academic_year"
                            class="form-control-custom"
                            value="{{ old('academic_year', $schoolClass->academic_year) }}"
                    ...
                    <div class="form-group">
                        ...
                        >
                            <option value="1"
                                {{ old('status', $schoolClass->status) == '1' ? 'selected' : '' }}>
                                Active
                            </option>

                            <option value="0"
                                {{ old('status', $schoolClass->status) == '0' ? 'selected' : '' }}>
                                Inactive
                            </option>
                        </select>
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ route('admin.classes.show', $schoolClass->id) }}"
